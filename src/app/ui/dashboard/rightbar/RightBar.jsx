...
const RightBar = () => {
  return (
    <div className="fixed">
      <div className=" relative flex flex-col  gap-5 rounded-xl pt-5  pb-5 pl-5 pr-5  mb-5 bg-gradient-to-t from-[#182237] to-[#253352] ">
        ...
        <div className="flex flex-col gap-3 ">
          ...
          <p className="text-xs font-medium text-[#b7bac1]">
      ...
      <div className="relative rounded-xl pt-5 pb-5 mb-5 bg-gradient-to-t from-[#182237] to-[#253352] ">
        <div className="flex flex-col gap-2 pt-5  pb-5 pl-5 pr-5">
          ...
          <p className="text-xs text-[#b7bac1] ">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Reprehenderit eius libero perspiciatis recusandae possimus.
          </p>
